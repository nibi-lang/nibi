...
public:
  ...
  //! \post If the module hasn't already been loaded it will be loaded into the target environment
  //! \note Check is_module_loaded() to see if the module has already been loaded
