...
nibi::cell_ptr nibi_fopen(nibi::interpreter_c &ci, nibi::cell_list_t &list,
  ...
  if (arg1->type != nibi::cell_type_e::STRING) {
    throw nibi::interpreter_c::exception_c("arg1 must be of type `string`", list[1]->locator);
  }
  if (arg2->type != nibi::cell_type_e::STRING) {
    throw nibi::interpreter_c::exception_c("arg2 must be of type `string`", list[2]->locator);
  }
...
nibi::cell_ptr nibi_fclose(nibi::interpreter_c &ci, nibi::cell_list_t &list,
  ...
  if (arg1->type != nibi::cell_type_e::PTR) {
    throw nibi::interpreter_c::exception_c("arg1 must be of type `ptr`", list[1]->locator);
  }
  if (arg1->data.ptr == nullptr) {
    return nibi::allocate_cell((int64_t)-1);
  }
  int64_t result = (fclose((FILE*)arg1->data.ptr));
  if (0 == result) { arg1->data.ptr = nullptr; }
...
nibi::cell_ptr nibi_fputs(nibi::interpreter_c &ci, nibi::cell_list_t &list,
  ...
  return nibi::allocate_cell((int64_t)(fputs(arg2->data.cstr, (FILE*)arg1->data.ptr)));
}
...
nibi::cell_ptr nibi_fprintf(nibi::interpreter_c &ci, nibi::cell_list_t &list,
  ...
  if (arg3->type != nibi::cell_type_e::STRING) {
    throw nibi::interpreter_c::exception_c("arg23must be of type `string`", list[3]->locator);
  }
  return nibi::allocate_cell((int64_t)(
        fprintf(
          (FILE*)arg1->data.ptr,
          arg2->data.cstr,
          arg3->data.cstr)));
...
nibi::cell_ptr nibi_fwrite(nibi::interpreter_c &ci, nibi::cell_list_t &list,
  ...
  if (arg2->type != nibi::cell_type_e::I64) {
    throw nibi::interpreter_c::exception_c("arg2 must be of type `i64`", list[2]->locator);
  }
  if (arg3->type != nibi::cell_type_e::I64) {
    throw nibi::interpreter_c::exception_c("arg3 must be of type `i64`", list[3]->locator);
  }
  if (arg4->type != nibi::cell_type_e::PTR) {
    throw nibi::interpreter_c::exception_c("arg4 must be of type `ptr`", list[4]->locator);
  }
