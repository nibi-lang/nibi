...
public:
  ...
  runtime_c(env_c &env, source_manager_c& source_manager, cell_memory_manager_t& instruction_memory);
  ...
  cell_memory_manager_t& get_runtime_memory() {
    return runtime_memory_;
  };

private:
  class exception_c final : public std::exception {
  public:
    exception_c(std::string message,
...
extern bool global_runtime_init(env_c &env, source_manager_c& source_manager, cell_memory_manager_t& instruction_memory);
